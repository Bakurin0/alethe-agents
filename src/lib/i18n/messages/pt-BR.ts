...
export const ptBR: Record<MessageKey, string> = {
  ...
  'whatsNew.v140.note1': 'Graphify: um painel de grafo de código por projeto, com o servidor MCP conectado automaticamente no Claude, Codex e OpenCode.',
  'whatsNew.v140.note2': 'Sidebar de projetos refeita: card fixo do projeto ativo, lista plana abaixo dele, monogramas coloridos, menu de ações sempre visível e indicador de atividade ao vivo.',
  'whatsNew.v140.note3': 'Contas locais mais seguras: visão de projetos e terminais por perfil, troca segura entre perfis, bloqueio de nomes duplicados e confirmação pelo nome antes de excluir uma conta.',
  'whatsNew.v140.note4': 'Home reconstruída em torno de um lançador rápido: escolha agente, permissões, prompt e pasta, e a tarefa vai direto para um novo terminal.',
  'whatsNew.v140.note5': 'Segurança de memória: sessões Claude agora iniciam em modo lean por padrão, e novos terminais são bloqueados quando o orçamento de memória fica crítico.',
  'whatsNew.v140.note6': 'Terminal mais confiável: as teclas são serializadas para reduzir travamentos, terminais Codex retomam a conversa automaticamente após reiniciar, e o foco de entrada volta após perda de contexto.',
  'whatsNew.v140.note7': 'Encerramento reforçado: terminais e agentes são sempre mortos ao sair, com uma guarda de Job Object no Windows cobrindo crashes.',
  'whatsNew.v140.note8': 'Preferências reorganizadas com categorias mais claras; a versão instalada foi para Preferências > Sobre.',
  'whatsNew.v140.note9': 'Markdown: copie a fonte completa com um clique, tanto no painel do workspace quanto na sidebar.',
  ...
  'whatsNew.v130.note4': 'Selecione terminais, comandos e READMEs com Shift para transformá-los em um único bloco visual.',
  'whatsNew.v130.note5': 'Armazenamento externo do Todo via `todos.jsonc`, sincronizado com a sidebar.',
  'whatsNew.v130.note6': 'Configuração automática do comando de terminal: o launcher `alethe` se instala e entra no PATH.',
  'whatsNew.v130.note7': 'O fluxo de novo projeto permite escolher a pasta antes e já abre o primeiro terminal nela.',
  'whatsNew.v130.note8': 'Sidebars recuperáveis, editor de projeto por abas e grupos arquiváveis.',
