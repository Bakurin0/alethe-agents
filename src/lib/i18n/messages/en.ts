...
export const en = {
  ...
  'whatsNew.v140.note1': 'Graphify: a per-project code graph panel, with the MCP server wired automatically into Claude, Codex and OpenCode.',
  'whatsNew.v140.note2': 'Projects sidebar rebuilt: a pinned active project card, a flat list below it, colored monograms, an always-visible actions menu, and a live activity indicator.',
  'whatsNew.v140.note3': 'Local accounts hardened: per-profile project and terminal view, safe profile switching, duplicate-name guard, and name confirmation before deleting a profile.',
  'whatsNew.v140.note4': 'Home rebuilt around a quick-start launcher: pick agent, permissions, prompt and folder, and the task is sent straight to a new terminal.',
  'whatsNew.v140.note5': 'Memory safety: Claude sessions now start in lean mode by default, and new terminals are blocked once the memory budget goes critical.',
  'whatsNew.v140.note6': 'Terminal reliability: keystrokes are serialized to cut down on freezes, Codex terminals resume their conversation automatically after a restart, and input focus returns after context loss.',
  'whatsNew.v140.note7': 'Shutdown reinforced: terminals and agents are always killed on exit, with a Windows Job Object guard covering crashes.',
  'whatsNew.v140.note8': 'Preferences reorganized with clearer categories; the installed version moved to Preferences > About.',
  'whatsNew.v140.note9': 'Markdown: copy the full source with one click, from both the workspace pane and the sidebar.',
  ...
  'whatsNew.v130.note4': 'Shift-select terminals, commands and READMEs into a single visual block.',
  'whatsNew.v130.note5': 'External Todo storage via `todos.jsonc`, kept in sync with the sidebar.',
  'whatsNew.v130.note6': 'Automatic terminal command setup: the `alethe` launcher installs itself and joins the PATH.',
  'whatsNew.v130.note7': 'New project flow lets you pick the folder up front and opens the first terminal already there.',
  'whatsNew.v130.note8': 'Recoverable sidebars, a tabbed project editor, and archivable groups.',
